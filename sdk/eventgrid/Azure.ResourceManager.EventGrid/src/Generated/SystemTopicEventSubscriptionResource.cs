...
namespace Azure.ResourceManager.EventGrid
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="SystemTopicEventSubscriptionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SystemTopicResource"/> using the GetSystemTopicEventSubscriptions method.
    /// </summary>
    public partial class SystemTopicEventSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of SystemTopicEventSubscriptionResource for mocking. </summary>
        protected SystemTopicEventSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SystemTopicEventSubscriptionResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/systemTopics/{systemTopicName}/eventSubscriptions/{eventSubscriptionName}";
        ...
        {
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<SystemTopicEventSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, EventGridSubscriptionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EventGridSubscriptionPatch.ToRequestContent(patch), context);
        ...
        {
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EventGridArmOperation operation = new EventGridArmOperation(_systemTopicEventSubscriptionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        {
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.GetDeliveryAttributes");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateGetDeliveryAttributesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        {
            using DiagnosticScope scope = _systemTopicEventSubscriptionsClientDiagnostics.CreateScope("SystemTopicEventSubscriptionResource.GetFullUri");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _systemTopicEventSubscriptionsRestClient.CreateGetFullUriRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
