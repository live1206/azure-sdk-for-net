...
namespace Azure.ResourceManager.EventGrid
{
    ...
    public partial class EventGridDomainPrivateLinkResourceData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EventGridDomainPrivateLinkResourceData"/>. </summary>
        ...
        internal EventGridDomainPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EventGridPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
