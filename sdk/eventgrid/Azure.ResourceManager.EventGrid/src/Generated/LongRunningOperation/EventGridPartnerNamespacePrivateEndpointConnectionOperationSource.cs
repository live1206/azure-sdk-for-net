...
{
    /// <summary></summary>
    internal partial class EventGridPartnerNamespacePrivateEndpointConnectionOperationSource : IOperationSource<EventGridPartnerNamespacePrivateEndpointConnectionResource>
    {
        ...
        EventGridPartnerNamespacePrivateEndpointConnectionResource IOperationSource<EventGridPartnerNamespacePrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            EventGridPartnerNamespacePrivateEndpointConnectionData data = EventGridPartnerNamespacePrivateEndpointConnectionData.DeserializeEventGridPartnerNamespacePrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
