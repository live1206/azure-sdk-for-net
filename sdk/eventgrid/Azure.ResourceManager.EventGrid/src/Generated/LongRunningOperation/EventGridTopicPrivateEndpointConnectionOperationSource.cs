...
{
    /// <summary></summary>
    internal partial class EventGridTopicPrivateEndpointConnectionOperationSource : IOperationSource<EventGridTopicPrivateEndpointConnectionResource>
    {
        ...
        EventGridTopicPrivateEndpointConnectionResource IOperationSource<EventGridTopicPrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            EventGridTopicPrivateEndpointConnectionData data = EventGridTopicPrivateEndpointConnectionData.DeserializeEventGridTopicPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
