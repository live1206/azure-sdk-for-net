...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT : AsyncPageable<NamespaceTopicEventSubscriptionData>
    {
        ...
        /// <summary> Initializes a new instance of NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT(NamespaceTopicEventSubscriptions client, Guid subscriptionId, string resourceGroupName, string namespaceName, string topicName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NamespaceTopicEventSubscriptionsGetByNamespaceTopicAsyncCollectionResultOfT as an enumerable collection. </summary>
