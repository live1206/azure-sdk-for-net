...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class ClientGroupsGetByNamespaceAsyncCollectionResultOfT : AsyncPageable<EventGridNamespaceClientGroupData>
    {
        ...
        /// <summary> Initializes a new instance of ClientGroupsGetByNamespaceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ClientGroupsGetByNamespaceAsyncCollectionResultOfT(ClientGroups client, Guid subscriptionId, string resourceGroupName, string namespaceName, string filter, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ClientGroupsGetByNamespaceAsyncCollectionResultOfT as an enumerable collection. </summary>
