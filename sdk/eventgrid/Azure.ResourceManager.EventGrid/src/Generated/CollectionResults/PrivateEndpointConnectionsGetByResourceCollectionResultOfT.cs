...
namespace Azure.ResourceManager.EventGrid
{
    internal partial class PrivateEndpointConnectionsGetByResourceCollectionResultOfT : Pageable<EventGridPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetByResourceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string domainName, string filter, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
