...
namespace Azure.ResourceManager.EventGrid
{
        ...
        IPersistableModel<EventGridPrivateLinkResourceData>
    {
        ...
        internal EventGridDomainPrivateLinkResource(ArmClient client, EventGridPrivateLinkResourceData data)
            : base(client, data.Id)
        {
            _data = data;
            HasData = true;
        ...
        internal EventGridDomainPrivateLinkResource(ArmClient client, ResourceIdentifier id)
            : base(client, id)
        {
        }
        ...
        {
            return new ResourceIdentifier($"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.EventGrid/domains/{parentName}/privateLinkResources/{privateLinkResourceName}");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiags.CreateScope("EventGridDomainPrivateLinkResource.Get");
            scope.Start();
            try
            {
