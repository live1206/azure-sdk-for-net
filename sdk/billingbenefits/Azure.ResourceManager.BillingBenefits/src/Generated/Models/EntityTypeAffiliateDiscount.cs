...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class EntityTypeAffiliateDiscount : DiscountProperties
    {
        ...
        public EntityTypeAffiliateDiscount(string productCode, DateTimeOffset startAt) : base(DiscountEntityType.Affiliate, productCode, startAt)
        {
        ...
        internal EntityTypeAffiliateDiscount(DiscountEntityType entityType, string productCode, DateTimeOffset startAt, string systemId, DiscountProvisioningState? provisioningState, ResourceIdentifier billingAccountResourceId, ResourceIdentifier billingProfileResourceId, ResourceIdentifier customerResourceId, string displayName, DiscountStatus? status, ResourceIdentifier benefitResourceId, DiscountAppliedScopeType? appliedScopeType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceIdentifier primaryResourceId, DateTimeOffset? endAt) : base(entityType, productCode, startAt, systemId, provisioningState, billingAccountResourceId, billingProfileResourceId, customerResourceId, displayName, status, benefitResourceId, appliedScopeType, additionalBinaryDataProperties)
        {
