...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class SavingsPlanModelProperties : IJsonModel<SavingsPlanModelProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(PurchaseDateTime))
            {
                writer.WritePropertyName("purchaseDateTime"u8);
                writer.WriteStringValue(PurchaseDateTime.Value, "O");
            }
            if (Optional.IsDefined(BenefitStartTime))
            {
                writer.WritePropertyName("benefitStartTime"u8);
                writer.WriteStringValue(BenefitStartTime.Value, "O");
            }
        ...
        internal static SavingsPlanModelProperties DeserializeSavingsPlanModelProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("purchaseDateTime"u8))
                {
                    ...
                    purchaseDateTime = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
                if (prop.NameEquals("benefitStartTime"u8))
                {
                    ...
                    benefitStartTime = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
