...
namespace Azure.ResourceManager.ScVmm
{
    ...
    public partial class ScVmmVirtualNetworkCollection : ArmCollection, IEnumerable<ScVmmVirtualNetworkResource>, IAsyncEnumerable<ScVmmVirtualNetworkResource>
    {
        ...
        {
            _scVmmVirtualNetworkVirtualNetworksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ScVmm", ScVmmVirtualNetworkResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ScVmmVirtualNetworkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string virtualNetworkName, ScVmmVirtualNetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ScVmmArmOperation<ScVmmVirtualNetworkResource>(new ScVmmVirtualNetworkOperationSource(Client), _scVmmVirtualNetworkVirtualNetworksClientDiagnostics, Pipeline, _scVmmVirtualNetworkVirtualNetworksRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, virtualNetworkName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
