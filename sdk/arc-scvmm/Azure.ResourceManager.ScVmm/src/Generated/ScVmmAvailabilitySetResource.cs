...
namespace Azure.ResourceManager.ScVmm
{
    ...
    public partial class ScVmmAvailabilitySetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ScVmmAvailabilitySetResource>> UpdateAsync(WaitUntil waitUntil, ScVmmAvailabilitySetPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<ScVmmAvailabilitySetResource> Update(WaitUntil waitUntil, ScVmmAvailabilitySetPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<Response<ScVmmAvailabilitySetResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var patch = new ScVmmAvailabilitySetPatch();
