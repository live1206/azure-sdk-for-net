...
{
    internal partial class SavingsPlanGetAllAsyncCollectionResultOfT : AsyncPageable<BillingBenefitsSavingsPlanData>
    {
        ...
        /// <returns> The pages of SavingsPlanGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<BillingBenefitsSavingsPlanData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<BillingBenefitsSavingsPlanData>.FromValues((IReadOnlyList<BillingBenefitsSavingsPlanData>)result.Value, nextPage?.AbsoluteUri, response);
