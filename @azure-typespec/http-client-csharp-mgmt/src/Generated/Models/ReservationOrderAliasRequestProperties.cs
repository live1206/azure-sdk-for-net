...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    internal partial class ReservationOrderAliasRequestProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ReservationOrderAliasRequestProperties"/>. </summary>
        ...
        internal ReservationOrderAliasRequestProperties(string displayName, ResourceIdentifier billingScopeId, BillingBenefitsTerm? term, BillingBenefitsBillingPlan? billingPlan, BillingBenefitsAppliedScopeType? appliedScopeType, BillingBenefitsAppliedScopeProperties appliedScopeProperties, int? quantity, bool? isRenew, BillingBenefitsReservedResourceType? reservedResourceType, DateTimeOffset? reviewDateTime, ReservationOrderAliasRequestPropertiesReservedResourceProperties reservedResourceProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
